...
export default function PrivacyPolicy() {
  const HeadingTag = usePageHeadingTag("privacy-policy");
  const { data: cmsData, loading } = useSectionData<any>("privacy-policy");
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://www.kumarpower.com/privacy-policy"
      />
      <Header />
            ...
            <div className="w-full lg:w-1/3 flex flex-col gap-8">
              ...
              <div className="bg-[#2D6FBA] rounded-3xl p-8 text-white shadow-xl">
                ...
                <p className="text-white/90 text-sm leading-relaxed mb-6">
                  Have questions regarding your commercial data, privacy rights,
                  or statutory compliance? Contact our support desk.
                </p>
