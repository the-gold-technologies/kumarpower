  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <Helmet>
          <title>
            Kumar Power – Our Certifications & Quality Standards</title>
          ...
          <link
            rel="canonical" href="https://www.kumarpower.com/about/certifications" />
        </Helmet>
        ...
        <section className="py-20 bg-black text-white">
          <div className="max-w-7xl mx-auto px-6">
            <h1 className="text-3xl font-bold mb-4 text-center">Awards and <span style={{ color: "#2D6FBA" }}>Certifications</span></h1>
              ...
              <div className="flex justify-center mt-10 gap-2">
                {certificateSlides.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-colors ${index === activeIndex ? 'bg-[#2D6FBA]' : 'bg-gray-600'
                      }`}
