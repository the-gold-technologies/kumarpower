...
import { useSectionData, usePageHeadingTag, useSocialLinks } from "@/store/useCMSStore";
...
const About = () => {
  ...
  // Social links — global single source of truth (Social Media CMS tab)
  const social = useSocialLinks();
  const connectTitle = social.connectTitle || "";
        ...
        <div className="bg-white py-12">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-0">
            ...
            <div className="flex-1 md:w-2/3 md:pl-12 mt-8 md:mt-0">
              ...
              {(linkedinUrl || youtubeUrl || instagramUrl || facebookUrl) && (
                <div className="mt-5 flex flex-wrap items-center gap-3">
                  ...
                  {facebookUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-[#1877F2]/10 text-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all duration-200 border border-[#1877F2]/20 hover:border-[#1877F2] shadow-sm hover:shadow"
                      title="Follow Kumar Power on Facebook"
                    >
